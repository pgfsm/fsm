...
| Output layout       | `<fsmLanguage>/actors/<src>/<src>.<ext>`                                                                                                                                        | `{cwd}/sync-worker/<lang>/<fsmName>/<fsmVersion>/actions/<index>`, `.../guards/<index>`, `.../delays/<index>` — always at `Deno.cwd()`, independent of `--folder`        |
