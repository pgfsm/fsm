...
| `fsm_core.select_all_transitions_v2` | `event_name text`, `input_state_value text[]`, `fsm_name_param text`, `fsm_version_param text` | — | `selectAllTransitions(deps, event_name, p_state_value, fsm_name_param, fsm_version_param)` | `fsm-helper.ts` |
...
| `fsm_core.lock_fsm_instance` | `input_fsm_instance_id uuid`, `input_locked_by text` | — | `lockFsmInstance(deps, p_fsm_instance_id)` | `fsm-instance-lock.ts` |
| `fsm_core.unlock_fsm_instance` | `input_fsm_instance_id uuid` | — | `unlockFsmInstance(deps, p_fsm_instance_id)` | `fsm-instance-lock.ts` |
