...
| `fsm_core.archive_event_from_fsm_promise_type_worker_v2` | `input_promise_queue_name text`, `input_promise_queue_type text`, `input_promise_queue_version text`, `input_promise_queue_msg_id bigint`, `input_event_name text`, `input_event_action_type text`, `input_event_data jsonb`, `input_event_delay integer`, `input_send_to_parent_queue_id uuid`, `input_send_to_parent_queue_id_event_name text`, `input_execution_started_at timestamptz`, `input_execution_duration integer`, `input_execution_finished_at timestamptz`, `input_event_status text`, `input_event_output jsonb`, `input_error_message text` | `send_event_to_fsm_queue_with_event_logs_v2` | `archiveEventFromFsmPromiseTypeWorker(deps, input_promise_queue_name, input_promise_queue_type, input_promise_queue_version, input_promise_queue_msg_id, input_event_name, input_event_action_type, input_event_data, input_event_delay, input_send_to_parent_queue_id, input_send_to_parent_queue_id_event_name, input_execution_started_at, input_execution_duration, input_execution_finished_at, input_event_status, input_event_output, input_error_message)` | `fsm-instance.ts` |
