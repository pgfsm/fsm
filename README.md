...
| Command             | `deno run --allow-all packages/fsm-compiler-ts/src/cli/index.ts -c generate-async-logic -f apps/fsm-core-example/fsm --plugin-root apps/fsm-core-example/fsm`                   | `deno run --allow-all packages/fsm-compiler-ts/src/cli/index.ts -c generate-sync-logic -f apps/fsm-core-example/fsm`                                                     |
...
`apps/fsm-core-example/fsm/worker-sdk-generated/<lang>/` (run that command first
if the directory doesn't exist yet — with
`--plugin-root
apps/fsm-core-example/fsm`, since that flag is what determines
...
deno run --allow-all apps/fsm-core-example/fsm/worker-sdk-generated/typescript/cli.ts start \
...
#   pip install -r apps/fsm-core-example/fsm/worker-sdk-generated/python/requirements.txt
python3 apps/fsm-core-example/fsm/worker-sdk-generated/python/cli.py start \
  --gateway-socket /tmp/pgfsm-activity-gateway-workers.sock
...
cd apps/fsm-core-example/fsm/worker-sdk-generated/go
...
cd apps/fsm-core-example/fsm/worker-sdk-generated/rust
