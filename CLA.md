...
Thank you for your interest in contributing to the FSM Framework project
("Project") maintained by pgfsm (https://github.com/pgfsm) ("We" or "Us").
...
future Contributions submitted to Us.
...
additions to an existing work, that is intentionally Submitted by You to Us for
...
systems managed by, or on behalf of, Us for the purpose of discussing and
...
alone or by combination of Your Contribution(s) with the Project to which such
...
Contributions into the Project. The decision to use or incorporate your
Contributions is entirely at Our discretion.
...
You acknowledge that We retain the right to offer the Project, including Your
Contributions, under different license terms (including proprietary licenses) in
addition to the open source license under which the Project is currently
provided. Nothing in this Agreement shall limit Our right to do so.

---

## How to Sign

Contributors sign this CLA automatically via the cla-assistant bot when opening
a Pull Request. The bot will post a comment on your PR with a link to sign. Your
signature is recorded and associated with your GitHub account.
