...
Deno.test("writeAggregateActorsRegistry - typescript re-imports and flattens each FSM-version's registry", async () => {
  ...
  try {
    ...
    assertEquals(
      content,
      "// AUTO-GENERATED by fsm-compiler-ts. Do not edit directly.\n" +
        'import { ACTOR_REGISTRATIONS as creditcheck_v01 } from "./creditCheck/v01/actors/generated-registry.ts";\n' +
        'import { ACTOR_REGISTRATIONS as otherfsm_v02 } from "./otherFsm/v02/actors/generated-registry.ts";\n' +
        "\n" +
  ...
  try {
    ...
    assertEquals(
      ...
      "# AUTO-GENERATED by fsm-compiler-ts. Do not edit directly.\n" +
        ...
        "from otherFsm.v02.actors.generated_registry import ACTOR_REGISTRATIONS as otherfsm_v02\n" +
        "\n" +
        "ACTOR_REGISTRATIONS = [\n" +
        "    *creditcheck_v01,\n" +
        "    *otherfsm_v02,\n" +
