...
async function removeStaleGeneratedFile(path: string): Promise<void> {
  ...
  if (!content.startsWith("// AUTO-GENERATED by fsm-compiler-ts.")) return;
 ...
 *
 * TypeScript gets no SDK source at all: `run-async-worker.ts` imports the
 * published `@pgfsm/async-worker-sdk` package (#358). Python/Rust/Go still get
 * `sdk.{py,rs,go}` written out, which, unlike the registries, don't vary per
