...
CREATE OR REPLACE FUNCTION public.fsm_get_all_initial_nodes_for_compound_nodes(root_id text, input_fsm_name text, input_fsm_version text)
 RETURNS ltree[]
 LANGUAGE plpgsql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION public.fsm_get_all_state_nodes_v1(p_state_paths text[], p_fsm_name text, p_fsm_version text)
 RETURNS text[]
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.fsm_get_initial_state_nodes_v1(p_fsm_name text, p_fsm_version text, p_state_path ltree)
 RETURNS text[]
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.fsm_get_initial_state_nodes_with_ancestors_v1(p_fsm_name text, p_fsm_version text, p_state_path ltree)
 RETURNS text[]
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.resolvestatevalue_v1(input_json jsonb, input_fsm_name text, input_fsm_version text)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
