...
create table "public"."all_transition_records" (
    "array_agg" jsonb[]
);


grant delete on table "public"."all_transition_records" to "anon";

grant insert on table "public"."all_transition_records" to "anon";

grant references on table "public"."all_transition_records" to "anon";

grant select on table "public"."all_transition_records" to "anon";

grant trigger on table "public"."all_transition_records" to "anon";

grant truncate on table "public"."all_transition_records" to "anon";

grant update on table "public"."all_transition_records" to "anon";

grant delete on table "public"."all_transition_records" to "authenticated";

grant insert on table "public"."all_transition_records" to "authenticated";

grant references on table "public"."all_transition_records" to "authenticated";

grant select on table "public"."all_transition_records" to "authenticated";

grant trigger on table "public"."all_transition_records" to "authenticated";

grant truncate on table "public"."all_transition_records" to "authenticated";

grant update on table "public"."all_transition_records" to "authenticated";

grant delete on table "public"."all_transition_records" to "service_role";

grant insert on table "public"."all_transition_records" to "service_role";

grant references on table "public"."all_transition_records" to "service_role";

grant select on table "public"."all_transition_records" to "service_role";

grant trigger on table "public"."all_transition_records" to "service_role";

grant truncate on table "public"."all_transition_records" to "service_role";

grant update on table "public"."all_transition_records" to "service_role";
