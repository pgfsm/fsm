...
BEGIN
    ...
    queue_msg_data := jsonb_build_object(
        ...
        'fsm_instance_id', input_promise_queue_name,
        'fsm_instance_id_fsm_type', input_promise_queue_type,
        'fsm_instance_id_fsm_version', input_promise_queue_version,
        'send_to_parent_queue_id', input_send_to_parent_queue_id,
        'send_to_parent_queue_type', input_promise_queue_type,
