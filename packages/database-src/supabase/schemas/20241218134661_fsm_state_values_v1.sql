...
-- SELECT fsm_core.fsm_get_initial_state_nodes_v1('creditCheckNiraj', 'v1', 'machine.creditCheck');

-- SELECT fsm_core.fsm_get_initial_state_nodes_v1('creditCheckNiraj', 'v1', 'machine.creditCheck.CheckingCreditScores');

-- SELECT fsm_core.fsm_get_initial_state_nodes_v1('creditCheckNiraj', 'v1', 'machine.creditCheck.CheckingCreditScores.CheckingGavperian');

-- SELECT fsm_core.fsm_get_initial_state_nodes_v1('creditCheckNiraj', 'v1', 'machine.creditCheck.CheckingCreditScores.CheckingGavperian.CheckingForExistingReport');
...
-- Example usage:
-- SELECT fsm_core.fsm_get_initial_state_nodes_with_ancestors_v1('creditCheckNiraj', 'v1', 'machine.creditCheck');

-- SELECT fsm_core.fsm_get_initial_state_nodes_with_ancestors_v1('creditCheckNiraj', 'v1', 'machine.creditCheck.CheckingCreditScores.CheckingGavperian');
    ...
    LOOP
        ...
        IF node_rec.type = 'compound' THEN
            ...
            IF temp_flag THEN
                ...
                initialStates := fsm_core.fsm_get_initial_state_nodes_with_ancestors_v1(p_fsm_name, p_fsm_version, node_rec.computed_state_key_ltree::ltree);
        ...
        ELSIF node_rec.type = 'parallel' THEN
            ...
            IF node_rec.states IS NOT NULL THEN
                FOR child_rec IN SELECT value FROM jsonb_each(node_rec.states) LOOP
                    ...
                    initialStates := fsm_core.fsm_get_initial_state_nodes_with_ancestors_v1(p_fsm_name, p_fsm_version, fsm_core.sanitize_text_to_ltree(child_rec.value->>'id'));
...
BEGIN
    ...
    all_nodes := fsm_core.fsm_get_all_state_nodes_v1(all_paths, input_fsm_name, input_fsm_version);
