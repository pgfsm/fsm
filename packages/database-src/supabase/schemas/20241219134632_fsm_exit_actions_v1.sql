...
BEGIN
    ...
    SELECT fsm_core.compute_exit_actions_v1(transition_record := transition_record, p_state_node_set := p_state_node_set, p_fsm_name := fsm_name_param, p_fsm_version := fsm_version_param) INTO result;
