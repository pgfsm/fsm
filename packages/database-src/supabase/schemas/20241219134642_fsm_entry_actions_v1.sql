DROP FUNCTION IF EXISTS fsm_core.get_descendant_states_for_entry_v1;
DROP FUNCTION IF EXISTS fsm_core.get_ancestor_states_for_entry_v1;
DROP TYPE IF EXISTS fsm_core.descendant_states_result_v1;
DROP TYPE IF EXISTS fsm_core.ancestor_states_result_v1;


CREATE OR REPLACE FUNCTION fsm_core.get_initial_actions_v1(
    p_state_paths TEXT[],
    p_fsm_name TEXT,
    p_fsm_version TEXT
)
...
CREATE OR REPLACE FUNCTION fsm_core.get_entry_actions_v1(
    p_state_paths TEXT[],
    p_fsm_name TEXT,
    p_fsm_version TEXT
)
...
RETURNS fsm_core.descendant_states_result_v1 AS $$
DECLARE
...
CREATE TYPE fsm_core.ancestor_states_result_v1 AS (
...
CREATE OR REPLACE FUNCTION fsm_core.get_ancestor_states_for_entry_v1(
...
) RETURNS fsm_core.ancestor_states_result_v1 AS $$
DECLARE
...
-- SELECT fsm_core.test_event_transition_for_entry_v1(
