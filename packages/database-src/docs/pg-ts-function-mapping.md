...
| `fsm_core.lock_fsm_instance` | `input_fsm_instance_id uuid`, `input_locked_by text` | — | `lockFsmInstance(deps, input_fsm_instance_id)` | `fsm-instance-lock.ts` |
| `fsm_core.unlock_fsm_instance` | `input_fsm_instance_id uuid` | — | `unlockFsmInstance(deps, input_fsm_instance_id)` | `fsm-instance-lock.ts` |
